...
interval = 7 # number files to be processed in a single job, take care to split your file so that you run on all files. The last job might be with smaller number of files (the ones that remain).
OutputFileNames = "hits_classifier" # base of the output file name, they will be saved in res directory
ScriptName = "pixelClassifier_cfg.py" # script to be used with cmsRun
FileList = "files_data.txt" # list with all the file directories
